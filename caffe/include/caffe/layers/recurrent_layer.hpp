...
class RecurrentLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  shared_ptr<Net<Dtype> > unrolled_net_; //net generated by recurrent
  ...
  Blob<Dtype>* x_input_blob_; //t * n ... n seqences with length t
  Blob<Dtype>* x_static_input_blob_; // the static input data put into all cells
  Blob<Dtype>* cont_input_blob_;// t* n
                                //[0,1]1 indicate this time and prevoius time are same sequence
};
